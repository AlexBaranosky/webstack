...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj12106 = {};return obj12106;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__9262__auto__ = this$;if(and__9262__auto__)
...
{var x__9901__auto__ = (((this$ == null))?null:this$);return (function (){var or__9274__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__9901__auto__)]);if(or__9274__auto__)
{return or__9274__auto__;
} else
{var or__9274__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__9274__auto____$1)
...
return (function (p__12107){var vec__12108 = p__12107;var k = cljs.core.nth.call(null,vec__12108,(0),null);var v = cljs.core.nth.call(null,vec__12108,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
