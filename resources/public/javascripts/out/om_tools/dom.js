...
*/
om_tools.dom.opt_key_case = (function opt_key_case(attr){if(cljs.core.truth_((function (){var or__8110__auto__ = (cljs.core.count.call(null,attr) < (5));if(or__8110__auto__)
...
*/
om_tools.dom.opt_key_alias = (function opt_key_alias(opt){var G__19152 = (((opt instanceof cljs.core.Keyword))?opt.fqn:null);switch (G__19152) {
case "for":
...
{return cljs.core.clj__GT_js.call(null,cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__19156){var vec__19157 = p__19156;var k = cljs.core.nth.call(null,vec__19157,(0),null);var v = cljs.core.nth.call(null,vec__19157,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [om_tools.dom.format_opt_key.call(null,k),om_tools.dom.format_opt_val.call(null,v)], null);
}),opts)));
} else
{return opts;
}
...
om_tools.dom.element = (function element(ctor,opts,children){var vec__19159 = om_tools.dom.element_args.call(null,opts,children);var opts__$1 = cljs.core.nth.call(null,vec__19159,(0),null);var children__$1 = cljs.core.nth.call(null,vec__19159,(1),null);return cljs.core.apply.call(null,ctor,cljs.core.flatten.call(null,cljs.core.cons.call(null,opts__$1,children__$1)));
});
om_tools.dom.class_set = (function class_set(m){var temp__4222__auto__ = cljs.core.seq.call(null,cljs.core.distinct.call(null,cljs.core.map.call(null,cljs.core.name,cljs.core.keys.call(null,cljs.core.filter.call(null,cljs.core.val,m)))));if(temp__4222__auto__)
{var ks = temp__4222__auto__;return clojure.string.join.call(null," ",ks);
} else
{return null;
}
});
