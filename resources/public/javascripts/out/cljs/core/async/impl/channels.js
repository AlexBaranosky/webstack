...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t23176 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t23176 = (function (val,box,meta23177){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t23176.cljs$lang$type = true;
cljs.core.async.impl.channels.t23176.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t23176";
cljs.core.async.impl.channels.t23176.cljs$lang$ctorPrWriter = (function (this__8677__auto__,writer__8678__auto__,opt__8679__auto__){return cljs.core._write.call(null,writer__8678__auto__,"cljs.core.async.impl.channels/t23176");
});
cljs.core.async.impl.channels.t23176.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t23176.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23178){var self__ = this;
var _23178__$1 = this;return self__.meta23177;
});
cljs.core.async.impl.channels.t23176.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23178,meta23177__$1){var self__ = this;
var _23178__$1 = this;return (new cljs.core.async.impl.channels.t23176(self__.val,self__.box,meta23177__$1));
});
cljs.core.async.impl.channels.__GT_t23176 = (function __GT_t23176(val__$1,box__$1,meta23177){return (new cljs.core.async.impl.channels.t23176(val__$1,box__$1,meta23177));
});
}
return (new cljs.core.async.impl.channels.t23176(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8680__auto__,writer__8681__auto__,opts__8682__auto__){return cljs.core._write.call(null,writer__8681__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8677__auto__,writer__8678__auto__,opt__8679__auto__){return cljs.core._write.call(null,writer__8678__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_23179 = self__.takes.pop();if((taker_23179 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_23179))
{var take_cb_23180 = cljs.core.async.impl.protocols.commit.call(null,taker_23179);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_23180,taker_23179,this$__$1){
return (function (){return take_cb_23180.call(null,null);
});})(take_cb_23180,taker_23179,this$__$1))
);
} else
{}
{
