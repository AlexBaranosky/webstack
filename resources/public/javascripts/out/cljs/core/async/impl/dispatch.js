...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_23170 = (0);while(true){
var m_23171 = cljs.core.async.impl.dispatch.tasks.pop();if((m_23171 == null))
{} else
{m_23171.call(null);
if((count_23170 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__23172 = (count_23170 + (1));
count_23170 = G__23172;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__8098__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__8098__auto__)
