...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8677__auto__,writer__8678__auto__,opt__8679__auto__){return cljs.core._write.call(null,writer__8678__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_23077 = (0);while(true){
if((i_23077 < arr.length))
{(arr[i_23077] = null);
{
var G__23078 = (i_23077 + (1));
i_23077 = G__23078;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8677__auto__,writer__8678__auto__,opt__8679__auto__){return cljs.core._write.call(null,writer__8678__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_23084 = (self__.level + (1));while(true){
if((i_23084 <= (new_level + (1))))
{(update[i_23084] = self__.header);
{
var G__23085 = (i_23084 + (1));
i_23084 = G__23085;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_23086 = (0);while(true){
if((i_23086 <= self__.level))
{var links_23087 = (update[i_23086]).forward;if(((links_23087[i_23086]) === x__$1))
{(links_23087[i_23086] = (x__$1.forward[i_23086]));
{
var G__23088 = (i_23086 + (1));
i_23086 = G__23088;
continue;
}
} else
{{
var G__23089 = (i_23086 + (1));
i_23086 = G__23089;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__8110__auto__ = (cljs.core.truth_((function (){var and__8098__auto__ = me;if(cljs.core.truth_(and__8098__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__8098__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__8110__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__8110__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__8110__auto__,timeout__$1,me))
,msecs);
