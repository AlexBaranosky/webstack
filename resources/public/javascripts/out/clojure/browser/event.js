...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj10436 = {};return obj10436;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__8098__auto__ = this$;if(and__8098__auto__)
...
{var x__8737__auto__ = (((this$ == null))?null:this$);return (function (){var or__8110__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8737__auto__)]);if(or__8110__auto__)
{return or__8110__auto__;
} else
{var or__8110__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__8110__auto____$1)
...
return (function (p__10437){var vec__10438 = p__10437;var k = cljs.core.nth.call(null,vec__10438,(0),null);var v = cljs.core.nth.call(null,vec__10438,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__10439){var vec__10440 = p__10439;var k = cljs.core.nth.call(null,vec__10440,(0),null);var v = cljs.core.nth.call(null,vec__10440,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
